...
export const AccountSettings = ({ opened, setOpened, userId }: Props) => {
    ...
    const { data, isLoading, isError } = useOne<GetFields<AccountSettingsGetUserQuery>>({
        resource: "users",
        id: userId,
        queryOptions: {
            enabled: opened,
    ...
    return (
        ...
        >
            <div className={styles.header}>
                <Text strong>{t('account_settings.title')}</Text>
                <Button
                    type="text"
                    icon={<CloseOutlined />}
                    onClick={() => closeModal()}
            ...
            <div className={styles.container}>
                ...
                <Card
                    title={
                        <Space size={15}>
                            <UserOutlined />
                            <Text size="sm">{t('account_settings.user_profile')}</Text>
                        </Space>
                    }
                ...
                >
                    <SingleElementForm
                        ...
                        itemProps={{
                            name: "jobTitle",
                            label: t('account_settings.job_title_label'),
                        }}
                    ...
                    <SingleElementForm
                        ...
                        itemProps={{
                            name: "phone",
                            label: t('account_settings.phone_label'),
                        }}
                    ...
                    <SingleElementForm
                        ...
                        itemProps={{
                            name: "timezone",
                            label: t('account_settings.timezone_label'),
                        }}
                ...
                <Card
                    title={
                        <Space size={15}>
                            <SafetyCertificateOutlined />
                            <Text size="sm">{t('account_settings.security')}</Text>
                        </Space>
                    }
                    headStyle={{ padding: "0 12px" }}
                    bodyStyle={{ padding: "0" }}
