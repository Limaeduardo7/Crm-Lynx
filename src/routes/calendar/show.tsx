...
export const CalendarShowPage: React.FC = () => {
    const { t } = useTranslation(); // Adicionando a constante para internacionalização
    ...
    // Se o evento durar mais de um dia, não mostrar o horário
    let allDay = false;
    // Verificar se dura mais de 23 horas
