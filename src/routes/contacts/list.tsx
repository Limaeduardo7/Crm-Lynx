        ...
        <div className="page-container">
            <List
                            ...
                            <Form {...searchFormProps} layout="inline">
                                <Form.Item name="name" noStyle>
                                    <Input
                                        ...
                                        placeholder={t(`contactsListPage.searchPlaceholder` as const)}
                            ...
                            {!screens.xs ? (
                                ...
                                >
                                    <Radio.Button value="table">
                                        <UnorderedListOutlined />
                                        {t(`contactsListPage.tableView` as const)}
                                    </Radio.Button>
                                    <Radio.Button value="card">
                                        <AppstoreOutlined />
                                        {t(`contactsListPage.cardView` as const)}
                                    </Radio.Button>
                                </Radio.Group>
                            ) : null}
                        </Space>
                ...
                title={
                    <ListTitleButton
                        toPath="contacts"
                        buttonText={t(`contactsListPage.addNewContactButton` as const)}
                    />
                }
            >
