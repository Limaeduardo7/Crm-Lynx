...
const ContactCommentListItem = ({ item }: { item: ContactNote }) => {
    ...
    >({
        ...
        successNotification: () => ({
            key: 'contact-note',
            message: t('contactCommentListItem.successfullyUpdated'),
            description: t('contactCommentListItem.successDescription'),
            type: 'success',
        }),
        meta: {
                            ...
                            rules={[
                                {
                                    ...
                                    message: t('contactCommentListItem.enterNote'),
                                },
                            ]}
                        >
                            <Input.TextArea
                    ...
                    <Space size={16}>
                        ...
                        <DeleteButton
                            ...
                            successNotification={() => ({
                                ...
                                message: t('contactCommentListItem.successfullyDeleted'),
                                description: t('contactCommentListItem.successDescription'),
                                type: 'success',
                            })}
                            icon={null}
                ...
                {id && (
                    <Space>
                        <Button size="small" onClick={() => setId(undefined)}>
                            {t('contactCommentListItem.cancel')}
                        </Button>
                        <Button
                            size="small"
                            type="primary"
