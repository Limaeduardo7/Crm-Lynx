    ...
    return (
        <Table
            ...
            pagination={{
                ...
                showTotal: (total) => (
                    <PaginationTotal total={total} entityName={t("tableView.entities.contacts")} />
                ),
            }}
            rowKey="id"
        >
            <Table.Column
                ...
                filterDropdown={(props) => (
                    <FilterDropdown {...props}>
                        <Input placeholder={t("tableView.Search.Name")} />
                    </FilterDropdown>
                )}
            ...
            <Table.Column
                ...
                filterDropdown={(props) => (
                    <FilterDropdown {...props}>
                        <Input placeholder={t("tableView.Search.Title")} />
                    </FilterDropdown>
                )}
            />
            <Table.Column
                dataIndex="status"
                title={t("tableView.Status")}
                sorter
