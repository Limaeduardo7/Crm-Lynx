...
export const SalesEditPage = () => {
    ...
    return (
        <Modal
            ...
            title={t("salesEditPage.editDeal")}
            width={512}
        >
            <Form {...formProps} layout="vertical" preserve={false}>
                <Form.Item
          label={t("salesEditPage.dealTitle")}
          name="title"
                    rules={[{ required: true }]}
                >
          <Input placeholder={t("salesEditPage.enterDealTitle")} />
                </Form.Item>
                <Form.Item
          label={t("salesEditPage.company")}
          initialValue={deal?.company?.id}
                ...
                >
                    <Select
            placeholder={t("salesEditPage.selectCompany")}
            {...companySelectProps}
                        options={
                ...
                <Row gutter={12}>
                    <Col span={12}>
                    <Form.Item label={t("salesEditPage.selectStage")} name="stageId">
                            <Select
                placeholder={t("salesEditPage.selectStage")}
                {...stageSelectProps}
                                showSearch={false}
                    ...
                    <Col span={12}>
                    <Form.Item label={t("salesEditPage.dealValue")} name="value">
                            <InputNumber
                                min={0}
                ...
                <Form.Item
          label={t("salesEditPage.dealOwner")}
          name="dealOwnerId"
                    rules={[{ required: true }]}
                >
                    <Select
            placeholder={t("salesEditPage.selectUser")}
            {...userSelectProps}
                        options={
