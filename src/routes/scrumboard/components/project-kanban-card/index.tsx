...
export const ProjectCard = ({
    ...
    const dropdownItems = useMemo(() => {
        const dropdownItems: MenuProps["items"] = [
            ...
            {
                danger: true,
                label: t("ProjectCard.deleteCard"),
                key: "2",
                icon: <DeleteOutlined />,
                onClick: () => {
                    mutate({
    ...
    const textColor = useMemo(() => {
        if (Typography.Text.defaultProps && Typography.Text.defaultProps.style) {
            return Typography.Text.defaultProps.style.color;
        }
        return undefined;
    }, []);
    ...
    return (
        <ConfigProvider
            theme={{
                components: {
                    Tag: {
                        colorText: textColor, // Obtém a cor padrão do Text
                    },
                    Card: {
                ...
                >
                    ...
                    {!!comments?.totalCount && (
                        ...
                        >
                            <MessageOutlined
                                style={{
                                    color: textColor, // Obtém a cor padrão do Text
                                    fontSize: "12px",
                                }}
                            />
