        ...
        <Card
            ...
            actions={[
                ...
                >
                    ...
                    >
                        <Text size="xs">{t("CompanyCard.relatedContacts")}</Text>
                        <AvatarGroup
                            size={"small"}
                            overlap
                            gap="4px"
                    ...
                    >
                        <Text size="xs">{t("CompanyCard.salesOwner")}</Text>
                        <Tooltip
            ...
            >
                <Dropdown
                    menu={{
                        items: [
                            {
                                label: t("CompanyCard.viewCompany"),
                                key: "1",
                                icon: <EyeOutlined />,
                                onClick: () => {
                            ...
                            {
                                danger: true,
                                label: t("CompanyCard.deleteCompany"),
                                key: "2",
                                icon: <DeleteOutlined />,
                                onClick: () => {
                                    mutate({
                ...
                >
                    <Text type="secondary">{t("CompanyCard.openDealsAmount")}</Text>
                    <Text
                        strong
                        size="md"
                        style={{
