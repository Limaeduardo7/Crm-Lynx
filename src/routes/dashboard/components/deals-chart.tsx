...
export const DashboardDealsChart: React.FC = () => {
        ...
        const won = data?.data
            ...
            ?.dealsAggregate.map((item) => {
                ...
                return {
                    ...
                    state: t('sales.dashboard.won'), // Tradução para "won"
                };
            });
        ...
        const lost = data?.data
            ...
            ?.dealsAggregate.map((item) => {
                ...
                return {
                    ...
                    timeText: date.format("MMM YYYY"),
                    value: item.sum?.value,
                    state: t('sales.dashboard.lost'), // Tradução para "lost"
                };
            });
    ...
    const config: AreaConfig = {
        ...
        areaStyle: (datum) => {
            ...
            return { fill: datum.state === t('sales.dashboard.won') ? won : lost };
        },
        color: (datum) => {
            return datum.state === t('sales.dashboard.won') ? "#52C41A" : "#F5222D";
        },
    };
        ...
        <Card
            ...
            title={
                ...
                >
                    <DollarOutlined />
                    <Text>
                        {t('sales.dashboard.dealsChartTitle')}
                    </Text>
                </div>
            }
            extra={
                ...
                <Button>
                    {t('sales.dashboard.seeSalesPipeline')}
                </Button>
            }
        >
            <Suspense>
