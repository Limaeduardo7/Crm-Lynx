    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {t(title)} {/* Utilização da tradução */}
                </Text>
            </div>
            <div
                style={{
...
const variants: {
    ...
    companies: {
        ...
        title: "dashboardTotalCountCard.companies", // Tradução necessária
        data: [
            {
                index: "1",
                value: 3500,
    ...
    contacts: {
        ...
        title: "dashboardTotalCountCard.contacts", // Tradução necessária
        data: [
            {
                index: "1",
                value: 10000,
    ...
    deals: {
        ...
        title: "dashboardTotalCountCard.deals", // Tradução necessária
        data: [
            {
                index: "1",
                value: 1000,
