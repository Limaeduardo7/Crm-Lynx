    ...
    return (
        <Card
            ...
            title={
                ...
                >
                    <DollarOutlined />
                    <Text size="sm">{t("dashboardTotalRevenueChart.totalRevenueYearly")}</Text> {/* Utilização da tradução */}
                </div>
            }
        >
            <Suspense>
            ...
            >
                <Space direction="vertical" size={0}>
                    <Text size="xs" className="secondary">
                        {t("dashboardTotalRevenueChart.expected")} {/* Utilização da tradução */}
                    </Text>
                ...
                <Space direction="vertical" size={0}>
                    <Text size="xs" className="secondary">
                        {t("dashboardTotalRevenueChart.realized")} {/* Utilização da tradução */}
                    </Text>
                    {!expectedRevenueIsLoading || !realizedRevenueIsLoading ? (
                        <Text
                            size="md"
