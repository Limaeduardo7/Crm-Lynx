...
const PdfExport = () => {
    ...
    return (
        <>
            ...
            >
                {t("PdfExport.convertToPDF")}
            </Button>

            <Modal {...modalProps} destroyOnClose width="80%" footer={null}>
                <PDFViewer style={styles.viewer}>
                    <Document title={`${t("PdfExport.quoteOf")} ${title}`}>
                        <Page style={styles.page} size="A4">
                            ...
                            >
                                ...
                                >
                                    <View>
                                        <Text>{t("PdfExport.preparedBy")}</Text>
                                        <Text>{contact?.name}</Text>
                                    </View>
                                    <View>
                                        <Text>{t("PdfExport.preparedFor")}</Text>
                            ...
                            <View style={styles.table}>
                                <View style={styles.tableRow}>
                                    ...
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>
                                            {t("PdfExport.unitPrice")}
                                        </Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>
                                            {t("PdfExport.quantity")}
                                        </Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>
                                            {t("PdfExport.discount")}
                                        </Text>
                                    </View>
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>
                                            {t("PdfExport.totalPrice")}
                                        </Text>
                                    </View>
                                </View>
                                {items?.map((item) => (
                            ...
                            >
                                ...
                                >
                                    <Text>{t("PdfExport.subtotal")}</Text>
                                    <Text>{t("PdfExport.salesTax")}</Text>
                                    <Text>{t("PdfExport.totalValue")}</Text>
                                </View>
                                <View
                                    style={{
                                        display: "flex",
