        ...
        >
            ...
            {!isLoading && (
                <>
                    ...
                    >
                        <div>
                            <Text size="sm">{t("ProductsServices.subtotal")}</Text>
                        </div>
                        <div>
                            <Text size="sm">
                    ...
                    >
                        <div>
                            <Text size="sm">{t("ProductsServices.salesTax")}</Text>
                        </div>
                        <div
                            style={{
                                width: "96px",
                    ...
                    >
                        <div>
                            <Text size="sm">{t("ProductsServices.totalValue")}</Text>
                        </div>
                        <div>
